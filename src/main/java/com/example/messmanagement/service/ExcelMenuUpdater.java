...
public class ExcelMenuUpdater {
    ...
    public void updateMenuFromExcel() {
        try (InputStream fis = new ClassPathResource("https://docs.google.com/spreadsheets/d/1FWPvpJOvkcbY9HzznMnhsiG0Z-3b3rQH/edit?usp=sharing&ouid=103080828134732057448&rtpof=true&sd=true").getInputStream();
